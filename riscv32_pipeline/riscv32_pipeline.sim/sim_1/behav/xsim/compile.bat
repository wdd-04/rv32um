...
REM
REM Generated by Vivado on Sat May 02 10:19:30 +0800 2026
...
echo "xvlog --incr --relax -prj tb_official_add_vlog.prj"
call xvlog  --incr --relax -prj tb_official_add_vlog.prj -log xvlog.log
