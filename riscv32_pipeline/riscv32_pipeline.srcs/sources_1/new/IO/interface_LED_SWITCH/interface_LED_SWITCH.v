...
module Interface_LED_SWITCH (
           ...
           input    wire [`IO_BUS_WIDTH_DATA - 1: 0]    wdata,
           inout    wire [`IO_BUS_WIDTH_DATA - 1: 0]    data, // 与�?�线连接
...
/***************************************************************
                        数据交叉�?�?
****************************************************************/
// 地址译码和控制�?�辑内部耦合，无�?数据交叉�?关控�?
// data输出控制
assign data =  (output_call) ? data_output :            // 总线同意，数据输�?
       `IO_BUS_WIDTH_DATA'hz;                   // 未定义状�?
// data输入控制
