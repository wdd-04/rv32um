...
// 寄存器写入控�?
`define REGWE_READ      1'b0    // 不可�?
`define REGWE_WRITE     1'b1    // 可写

// ALU 输入控制（COMP输入相反�?
`define ASEL_REG        1'b0    // 选择寄存器输�? A
`define ASEL_PC         1'b1    // 选择 PC 输入 A
`define BSEL_REG        1'b0    // 选择寄存器输�? B
`define BSEL_IMM        1'b1    // 选择立即数输�? B
`define ASEL_FORWARDING 1'b1
`define BSEL_FORWARDING 1'b1 

// 写主存控�?
`define DRAM_READ       1'b0    // 不可�?
...
// 接口
`define IO_INTERFACE_NUM    5

// 总线宽度
`define IO_BUS_WIDTH_ADDR   32  // 地址线宽�?
`define IO_BUS_WIDTH_DATA   32  // 数据线宽�?
`define IO_BUS_WIDTH_CTRL   1   // 控制线宽�?
...
`define IO_CALL_STATU      2'b10    // 状�?�传�?
